...
def init_commands():
    ...
    from user_interface_menus._menu_helper import README
    ...
    _menu_options = {
        ...
        'params type speed': {'description': 'Manage typing speed of header messages', 'menu_caller': lambda self: PARAM_ASSISTANT_TYPE_SPEED(self)},
